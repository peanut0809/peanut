...
// EventeSuperSmallProgramRelease is the golang structure of table evente_super_small_program_release for DAO operations like Where/Data.
type EventeSuperSmallProgramRelease struct {
	g.Meta         `orm:"table:evente_super_small_program_release, do:true"`
	Id             interface{} //
