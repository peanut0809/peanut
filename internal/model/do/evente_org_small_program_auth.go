...
// EventeOrgSmallProgramAuth is the golang structure of table evente_org_small_program_auth for DAO operations like Where/Data.
type EventeOrgSmallProgramAuth struct {
	g.Meta                 `orm:"table:evente_org_small_program_auth, do:true"`
	Id                     interface{} //
