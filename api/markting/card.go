...
type CardGetListCommonReq struct {
	g.Meta   `path:"/card/items" tags:"card" method:"get"`
	CardName string `json:"card_name"   in:"query" dc:"次卡名称"`
	CommonPaginationReq
}
type CardGetListCommonRes struct {
	Page  int         `json:"page"`
	Size  int         `json:"size"`
